...
public class stories_fragment1 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myRef = FirebaseDatabase.getInstance().getReference().child("Feed");


        //myRef = database.getReference("Feed");
        myRefusers = FirebaseDatabase.getInstance().getReference().child("Users");
        myRefLikes = FirebaseDatabase.getInstance().getReference().child("Likes");
    ...
    public void onStart() {
        ...
        firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<ModelClass1, stories_fragment1.BlogViewHolder>(
                        ModelClass1.class,
                        R.layout.stories_header,
                        stories_fragment1.BlogViewHolder.class,
                        myRef)  {



                    @Override
                    protected void populateViewHolder(final stories_fragment1.BlogViewHolder viewHolder, final ModelClass1 model, int position) {
                        ...
                        viewHolder.setFiltername(model.getFiltername());
                        ...
                        myRef.child(postkey).child("likes").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot snapshot) {



                                nooflikes = snapshot.getValue().toString();
                        ...
                        if (nooflikes== null||nooflikes.contains("0")){

                            viewHolder.mytextview3.setVisibility(View.GONE);


                        }

                        else {
                            viewHolder.mytextview3.setVisibility(View.VISIBLE   );
                        ...
                        viewHolder.mlikebutton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                mProcesslike = true;
                                    ...
                                    myRefLikes.addValueEventListener(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(DataSnapshot dataSnapshot) {

                                            if (mProcesslike){

                                            SharedPreferences sp2 = getActivity().getSharedPreferences("Login", 0);

                                            String userid1 = sp2.getString("id", null);




                                            if (dataSnapshot.child(postkey).hasChild(userid1)) {



                                                myRefLikes.child(postkey).child(userid1).removeValue();

                                                int noflike = Integer.valueOf(nooflikes);

                                                noflike = noflike - 1;
                                                myRef.child(postkey).child("likes").setValue(String.valueOf(noflike));
                                                ...
                                                if (nooflikes == null || nooflikes.equals("")) {
                                                    ...
                                                    myRefLikes.child(postkey).child(userid).setValue("Randomnvalue");

                                                    myRef.child(postkey).child("likes").setValue("1");
    ...
    public static class BlogViewHolder extends RecyclerView.ViewHolder  {
        ...
        public BlogViewHolder(View itemView) {
            ...
            SharedPreferences sp2 = ctx.getSharedPreferences("Login", 0);

            userid1 = sp2.getString("id", null);
            ...
            TextView post_title5 = (TextView)mView.findViewById(R.id.description);
            TextView post_title6 = (TextView)mView.findViewById(R.id.filtername);
            ...
            Typeface mytypeface3 = Typeface.createFromAsset(itemView.getContext().getAssets(), "Montserrat-Regular.ttf");
             mytextview3 = (TextView) mView.findViewById(R.id.likes);
            ...
            Typeface mytypeface5 = Typeface.createFromAsset(itemView.getContext().getAssets(), "averta.otf");

            post_title5.setTypeface(mytypeface1);
            post_title6.setTypeface(mytypeface5);
        ...
        public void setlikebutton (final String postkey1){


            mlikebutton = (ToggleButton)mView.findViewById(R.id.likebutton);
            ...
            mdatabaselikes.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.child(postkey1).hasChild(userid1)) {
        ...
        public void setLikes(String likes){
            ...
            post_title3.setText(likes + " Likes");
        ...
        public void setDescription(String description){
            ...
            TextView post_title5 = (TextView)mView.findViewById(R.id.description);
            post_title5.setText(description);
        ...
        public void setFiltername(String filtername){
            ...
            TextView post_title6 = (TextView)mView.findViewById(R.id.filtername);
            post_title6.setText(filtername);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAMERA_REQUEST && resultCode == Activity.RESULT_OK) {
            ...
            i.putExtra("uripath", (FileProvider.getUriForFile(getActivity().getApplicationContext(), BuildConfig.APPLICATION_ID + ".provider", imagefile)).toString());
            startActivity(i);
