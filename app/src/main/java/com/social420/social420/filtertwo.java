...
public class filtertwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = (View) inflater.inflate(R.layout.filtertwo, container, false);

        filterimage = (ImageView)rootview.findViewById(R.id.filtered2);

        Typeface mytypeface2 = Typeface.createFromAsset(getContext().getAssets(), "alarmclock.ttf");
        ...
        int color = Color.argb(60, 153, 86, 37);
