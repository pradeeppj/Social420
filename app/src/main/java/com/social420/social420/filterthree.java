...
public class filterthree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = (View) inflater.inflate(R.layout.filterthree, container, false);

        filterimage = (ImageView)rootview.findViewById(R.id.filtered3);

        Typeface mytypeface2 = Typeface.createFromAsset(getContext().getAssets(), "road.otf");
        ...
        int color = Color.argb(60, 71, 159, 216);
