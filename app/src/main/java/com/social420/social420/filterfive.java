...
public class filterfive extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = (View) inflater.inflate(R.layout.filterfive, container, false);

        filterimage = (ImageView)rootview.findViewById(R.id.filtered5);

        Typeface mytypeface2 = Typeface.createFromAsset(getContext().getAssets(), "BreeSerif-Regular.ttf");
